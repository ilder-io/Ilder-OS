...
/**
 * Ilder OS design tokens.
 * Direction: minimal, dark-first, data-dense premium SaaS
 * (Linear / Vercel / Notion register). One accent, used sparingly.
 * Numerals are set in a mono face for a "system dashboard" signature.
 */
const config: Config = {
  darkMode: ["class"],
  content: [
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        elevated: "0 8px 30px -6px rgb(0 0 0 / 0.5)",
